...
public class AwsSecretProvider implements SecretProvider {
    ...
    /**
     * AWS-specific configuration (region, endpoint).
     */
    private final SecretManagerProperties.Aws properties;

    public AwsSecretProvider(SecretsManagerClient client, SecretManagerProperties.Aws properties) {
        this.client = client;
    ...
    public Optional<String> getSecret(String key, String version) {
        try {
            ...
            // GENERIC AWS ERROR: Default non-retryable
    ...
    public void validateConfiguration() {
        log.info("AWS Secrets Manager provider configuration validated (region: {})",
                properties.getRegion() != null ? properties.getRegion() : "default");
    }
